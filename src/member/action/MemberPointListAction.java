	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String id = (String)session.getAttribute("id");
			...
			if(id==null) {
				...
				listCount = userService.myPointListCount(user_id, start, end);
				pointList = userService.myPointList(user_id, start, end, page);
				...
				forward= new ActionForward("./admin/usPoint.jsp",false);
			}
		return forward;
	}
