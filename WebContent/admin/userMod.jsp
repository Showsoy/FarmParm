...
<div class="pageform">
	...
	<tr>
		...
		<td><input type="text" id="userName" name="userName" value="${user.name}" required="required"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td rowspan="3">
		<input type="text" name="userAddr1" id="userAddr1"size="7" value="${user.postcode}" required="required"/>
		<button type="button" onclick="sample6_execDaumPostcode()" id="gbutton" style="width:70px;margin-bottom:1px;">주소검색</button><br>
		<input type="text" name="userAddr2" id="userAddr2" placeholder="주소" size="40" value="${user.address}" style="margin-bottom:1px;" required="required"/><br>
...
<br>
			<section>
				...
				<button id="sbutton" type="button" onclick="location.href='userView.us?user_id=${user.user_id}'">뒤로가기</button>
			</section>
		</form>
	</div>
</div>
