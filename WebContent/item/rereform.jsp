...
<div id="grade"><b id="grade_deco">|</b> 후기답글</div>
<form action="reReply.bo" name="reviewform" method="post" onsubmit="return chkForm(this)">
<c:choose>
	...
	<c:when test="${id == null || (id != null && id != 'admin') }">
		<p>권한이 없습니다.</p>
		<button type="button" onclick="fclose(this)" id="wbutton">닫기</button>
	</c:when>
